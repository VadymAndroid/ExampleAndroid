...
public final class LoadProfileUseCase_MembersInjector
    implements MembersInjector<LoadProfileUseCase> {
  ...
  public LoadProfileUseCase_MembersInjector(
  ...
  public static MembersInjector<LoadProfileUseCase> create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new LoadProfileUseCase_MembersInjector(
  ...
  @Override
  public void injectMembers(LoadProfileUseCase instance) {
