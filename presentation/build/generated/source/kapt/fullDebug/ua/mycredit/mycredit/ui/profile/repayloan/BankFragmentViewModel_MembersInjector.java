...
public final class BankFragmentViewModel_MembersInjector
    implements MembersInjector<BankFragmentViewModel> {
  ...
  public BankFragmentViewModel_MembersInjector(
  ...
  public static MembersInjector<BankFragmentViewModel> create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new BankFragmentViewModel_MembersInjector(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  @Override
  public void injectMembers(BankFragmentViewModel instance) {
