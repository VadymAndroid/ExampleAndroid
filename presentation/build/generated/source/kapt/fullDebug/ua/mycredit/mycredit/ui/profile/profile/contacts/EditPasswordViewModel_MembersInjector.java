...
public final class EditPasswordViewModel_MembersInjector
    implements MembersInjector<EditPasswordViewModel> {
  ...
  public EditPasswordViewModel_MembersInjector(
  ...
  public static MembersInjector<EditPasswordViewModel> create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new EditPasswordViewModel_MembersInjector(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  @Override
  public void injectMembers(EditPasswordViewModel instance) {
