...
public final class GetStatusUseCase_MembersInjector implements MembersInjector<GetStatusUseCase> {
  ...
  public GetStatusUseCase_MembersInjector(
  ...
  public static MembersInjector<GetStatusUseCase> create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new GetStatusUseCase_MembersInjector(
  ...
  @Override
  public void injectMembers(GetStatusUseCase instance) {
