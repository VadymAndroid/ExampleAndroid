...
public final class CardSmsConfirmationFragment_MembersInjector
    implements MembersInjector<CardSmsConfirmationFragment> {
  ...
  public CardSmsConfirmationFragment_MembersInjector(
  ...
  public static MembersInjector<CardSmsConfirmationFragment> create(
      Provider<DispatchingAndroidInjector<Fragment>> childFragmentInjectorProvider,
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<LocalStorage> storageProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new CardSmsConfirmationFragment_MembersInjector(
  ...
  @Override
  public void injectMembers(CardSmsConfirmationFragment instance) {
