...
public final class PhoneContactsUseCase_Factory implements Factory<PhoneContactsUseCase> {
  ...
  public PhoneContactsUseCase_Factory(
  ...
  @Override
  public PhoneContactsUseCase get() {
  ...
  public static PhoneContactsUseCase provideInstance(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    PhoneContactsUseCase instance = new PhoneContactsUseCase();
  ...
  public static PhoneContactsUseCase_Factory create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new PhoneContactsUseCase_Factory(
        networkFacadeProvider,
        localStorageProvider,
        schedulersProvider,
        loggerProvider,
  ...
  public static PhoneContactsUseCase newPhoneContactsUseCase() {
    return new PhoneContactsUseCase();
  }
}
