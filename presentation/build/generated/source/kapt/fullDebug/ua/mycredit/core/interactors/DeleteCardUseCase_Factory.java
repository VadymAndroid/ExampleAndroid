...
public final class DeleteCardUseCase_Factory implements Factory<DeleteCardUseCase> {
  ...
  public DeleteCardUseCase_Factory(
  ...
  public static DeleteCardUseCase provideInstance(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    DeleteCardUseCase instance = new DeleteCardUseCase();
  ...
  public static DeleteCardUseCase_Factory create(
      ...
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new DeleteCardUseCase_Factory(
        networkFacadeProvider,
        localStorageProvider,
        schedulersProvider,
        loggerProvider,
  ...
  public static DeleteCardUseCase newDeleteCardUseCase() {
