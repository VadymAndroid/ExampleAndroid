...
public final class AgreementViewModel_MembersInjector
    implements MembersInjector<AgreementViewModel> {
  ...
  public AgreementViewModel_MembersInjector(
  ...
  public static MembersInjector<AgreementViewModel> create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new AgreementViewModel_MembersInjector(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  @Override
  public void injectMembers(AgreementViewModel instance) {
