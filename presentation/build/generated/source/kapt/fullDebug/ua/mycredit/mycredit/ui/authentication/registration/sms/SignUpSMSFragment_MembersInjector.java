...
public final class SignUpSMSFragment_MembersInjector implements MembersInjector<SignUpSMSFragment> {
  ...
  public SignUpSMSFragment_MembersInjector(
  ...
  public static MembersInjector<SignUpSMSFragment> create(
      Provider<DispatchingAndroidInjector<Fragment>> childFragmentInjectorProvider,
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<LocalStorage> storageProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new SignUpSMSFragment_MembersInjector(
  ...
  @Override
  public void injectMembers(SignUpSMSFragment instance) {
