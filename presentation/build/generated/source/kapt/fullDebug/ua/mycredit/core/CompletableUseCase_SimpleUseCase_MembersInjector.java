...
public final class CompletableUseCase_SimpleUseCase_MembersInjector
    implements MembersInjector<CompletableUseCase.SimpleUseCase> {
  ...
  public CompletableUseCase_SimpleUseCase_MembersInjector(
  ...
  public static MembersInjector<CompletableUseCase.SimpleUseCase> create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new CompletableUseCase_SimpleUseCase_MembersInjector(
  ...
  @Override
  public void injectMembers(CompletableUseCase.SimpleUseCase instance) {
