...
public final class MyCreditWebViewFragment_MembersInjector
    implements MembersInjector<MyCreditWebViewFragment> {
  ...
  public MyCreditWebViewFragment_MembersInjector(
  ...
  public static MembersInjector<MyCreditWebViewFragment> create(
      Provider<DispatchingAndroidInjector<Fragment>> childFragmentInjectorProvider,
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<LocalStorage> storageProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new MyCreditWebViewFragment_MembersInjector(
  ...
  @Override
  public void injectMembers(MyCreditWebViewFragment instance) {
