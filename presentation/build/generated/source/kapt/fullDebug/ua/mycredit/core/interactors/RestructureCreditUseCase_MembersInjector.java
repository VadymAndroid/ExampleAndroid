...
public final class RestructureCreditUseCase_MembersInjector
    implements MembersInjector<RestructureCreditUseCase> {
  ...
  public RestructureCreditUseCase_MembersInjector(
  ...
  public static MembersInjector<RestructureCreditUseCase> create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new RestructureCreditUseCase_MembersInjector(
  ...
  @Override
  public void injectMembers(RestructureCreditUseCase instance) {
