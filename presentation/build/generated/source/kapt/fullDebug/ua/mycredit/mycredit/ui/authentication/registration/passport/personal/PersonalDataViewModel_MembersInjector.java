...
public final class PersonalDataViewModel_MembersInjector
    implements MembersInjector<PersonalDataViewModel> {
  ...
  public PersonalDataViewModel_MembersInjector(
  ...
  public static MembersInjector<PersonalDataViewModel> create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new PersonalDataViewModel_MembersInjector(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  @Override
  public void injectMembers(PersonalDataViewModel instance) {
