...
public final class FinanceFragment_MembersInjector implements MembersInjector<FinanceFragment> {
  ...
  public FinanceFragment_MembersInjector(
  ...
  public static MembersInjector<FinanceFragment> create(
      Provider<DispatchingAndroidInjector<Fragment>> childFragmentInjectorProvider,
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<LocalStorage> storageProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new FinanceFragment_MembersInjector(
  ...
  @Override
  public void injectMembers(FinanceFragment instance) {
