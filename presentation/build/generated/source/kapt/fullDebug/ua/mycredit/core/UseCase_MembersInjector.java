...
public final class UseCase_MembersInjector<P, R> implements MembersInjector<UseCase<P, R>> {
  ...
  public UseCase_MembersInjector(
  ...
  public static <P, R> MembersInjector<UseCase<P, R>> create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new UseCase_MembersInjector<P, R>(
  ...
  @Override
  public void injectMembers(UseCase<P, R> instance) {
