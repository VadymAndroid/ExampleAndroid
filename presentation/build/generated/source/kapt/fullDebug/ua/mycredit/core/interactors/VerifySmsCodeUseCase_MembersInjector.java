...
public final class VerifySmsCodeUseCase_MembersInjector
    implements MembersInjector<VerifySmsCodeUseCase> {
  ...
  public VerifySmsCodeUseCase_MembersInjector(
  ...
  public static MembersInjector<VerifySmsCodeUseCase> create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new VerifySmsCodeUseCase_MembersInjector(
  ...
  @Override
  public void injectMembers(VerifySmsCodeUseCase instance) {
