...
public final class FormViewModel_MembersInjector implements MembersInjector<FormViewModel> {
  ...
  public FormViewModel_MembersInjector(
  ...
  public static MembersInjector<FormViewModel> create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new FormViewModel_MembersInjector(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  @Override
  public void injectMembers(FormViewModel instance) {
    ...
    injectInitFields(instance);
  }

  public static void injectInitFields(FormViewModel instance) {
    instance.initFields();
  }
}
