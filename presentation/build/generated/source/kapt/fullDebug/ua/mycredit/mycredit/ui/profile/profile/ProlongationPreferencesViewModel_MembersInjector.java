...
public final class ProlongationPreferencesViewModel_MembersInjector
    implements MembersInjector<ProlongationPreferencesViewModel> {
  ...
  public ProlongationPreferencesViewModel_MembersInjector(
  ...
  public static MembersInjector<ProlongationPreferencesViewModel> create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new ProlongationPreferencesViewModel_MembersInjector(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  @Override
  public void injectMembers(ProlongationPreferencesViewModel instance) {
