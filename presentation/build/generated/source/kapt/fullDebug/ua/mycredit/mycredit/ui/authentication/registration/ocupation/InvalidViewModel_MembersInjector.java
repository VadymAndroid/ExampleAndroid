...
public final class InvalidViewModel_MembersInjector implements MembersInjector<InvalidViewModel> {
  ...
  public InvalidViewModel_MembersInjector(
  ...
  public static MembersInjector<InvalidViewModel> create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new InvalidViewModel_MembersInjector(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  @Override
  public void injectMembers(InvalidViewModel instance) {
