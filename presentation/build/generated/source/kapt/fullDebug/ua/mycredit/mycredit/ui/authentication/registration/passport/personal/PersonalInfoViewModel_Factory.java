...
public final class PersonalInfoViewModel_Factory implements Factory<PersonalInfoViewModel> {
  ...
  public PersonalInfoViewModel_Factory(
  ...
  public static PersonalInfoViewModel provideInstance(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    PersonalInfoViewModel instance = new PersonalInfoViewModel();
  ...
  public static PersonalInfoViewModel_Factory create(
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new PersonalInfoViewModel_Factory(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  public static PersonalInfoViewModel newPersonalInfoViewModel() {
