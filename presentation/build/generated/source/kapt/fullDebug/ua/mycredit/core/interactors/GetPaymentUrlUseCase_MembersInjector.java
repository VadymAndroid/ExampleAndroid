...
public final class GetPaymentUrlUseCase_MembersInjector
    implements MembersInjector<GetPaymentUrlUseCase> {
  ...
  public GetPaymentUrlUseCase_MembersInjector(
  ...
  public static MembersInjector<GetPaymentUrlUseCase> create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new GetPaymentUrlUseCase_MembersInjector(
  ...
  @Override
  public void injectMembers(GetPaymentUrlUseCase instance) {
