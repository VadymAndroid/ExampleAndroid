...
public final class EmployedViewModel_Factory implements Factory<EmployedViewModel> {
  ...
  public EmployedViewModel_Factory(
  ...
  public static EmployedViewModel provideInstance(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    EmployedViewModel instance = new EmployedViewModel();
  ...
  public static EmployedViewModel_Factory create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new EmployedViewModel_Factory(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  public static EmployedViewModel newEmployedViewModel() {
    return new EmployedViewModel();
  }
}
