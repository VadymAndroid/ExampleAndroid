...
public final class PassportViewModel_MembersInjector implements MembersInjector<PassportViewModel> {
  ...
  public PassportViewModel_MembersInjector(
  ...
  public static MembersInjector<PassportViewModel> create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new PassportViewModel_MembersInjector(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  @Override
  public void injectMembers(PassportViewModel instance) {
