...
public final class UnemployedViewModel_Factory implements Factory<UnemployedViewModel> {
  ...
  public UnemployedViewModel_Factory(
  ...
  @Override
  public UnemployedViewModel get() {
  ...
  public static UnemployedViewModel provideInstance(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    UnemployedViewModel instance = new UnemployedViewModel();
  ...
  public static UnemployedViewModel_Factory create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new UnemployedViewModel_Factory(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  public static UnemployedViewModel newUnemployedViewModel() {
    return new UnemployedViewModel();
  }
}
