...
public final class HousewifeFragment_MembersInjector implements MembersInjector<HousewifeFragment> {
  ...
  public HousewifeFragment_MembersInjector(
  ...
  public static MembersInjector<HousewifeFragment> create(
      Provider<DispatchingAndroidInjector<Fragment>> childFragmentInjectorProvider,
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<LocalStorage> storageProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new HousewifeFragment_MembersInjector(
  ...
  @Override
  public void injectMembers(HousewifeFragment instance) {
