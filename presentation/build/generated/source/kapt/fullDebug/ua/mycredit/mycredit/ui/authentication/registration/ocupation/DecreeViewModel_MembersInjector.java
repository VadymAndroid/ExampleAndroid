...
public final class DecreeViewModel_MembersInjector implements MembersInjector<DecreeViewModel> {
  ...
  public DecreeViewModel_MembersInjector(
  ...
  public static MembersInjector<DecreeViewModel> create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new DecreeViewModel_MembersInjector(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  @Override
  public void injectMembers(DecreeViewModel instance) {
