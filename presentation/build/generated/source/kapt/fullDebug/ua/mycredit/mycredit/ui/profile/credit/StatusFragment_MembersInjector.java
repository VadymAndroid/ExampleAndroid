...
public final class StatusFragment_MembersInjector implements MembersInjector<StatusFragment> {
  ...
  public StatusFragment_MembersInjector(
  ...
  public static MembersInjector<StatusFragment> create(
      Provider<DispatchingAndroidInjector<Fragment>> childFragmentInjectorProvider,
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<LocalStorage> storageProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new StatusFragment_MembersInjector(
  ...
  @Override
  public void injectMembers(StatusFragment instance) {
