...
public final class RequestSmsIfPhoneValidUseCase_Factory
    implements Factory<RequestSmsIfPhoneValidUseCase> {
  ...
  public RequestSmsIfPhoneValidUseCase_Factory(
  ...
  @Override
  public RequestSmsIfPhoneValidUseCase get() {
  ...
  public static RequestSmsIfPhoneValidUseCase provideInstance(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    RequestSmsIfPhoneValidUseCase instance = new RequestSmsIfPhoneValidUseCase();
  ...
  public static RequestSmsIfPhoneValidUseCase_Factory create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new RequestSmsIfPhoneValidUseCase_Factory(
        networkFacadeProvider,
        localStorageProvider,
        schedulersProvider,
        loggerProvider,
  ...
  public static RequestSmsIfPhoneValidUseCase newRequestSmsIfPhoneValidUseCase() {
    return new RequestSmsIfPhoneValidUseCase();
  }
}
