...
public final class BaseSmsCodeViewModel_MembersInjector
    implements MembersInjector<BaseSmsCodeViewModel> {
  ...
  public BaseSmsCodeViewModel_MembersInjector(
  ...
  public static MembersInjector<BaseSmsCodeViewModel> create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new BaseSmsCodeViewModel_MembersInjector(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  @Override
  public void injectMembers(BaseSmsCodeViewModel instance) {
