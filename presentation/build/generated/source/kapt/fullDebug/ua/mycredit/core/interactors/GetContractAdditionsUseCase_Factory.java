...
public final class GetContractAdditionsUseCase_Factory
    implements Factory<GetContractAdditionsUseCase> {
  ...
  public GetContractAdditionsUseCase_Factory(
  ...
  @Override
  public GetContractAdditionsUseCase get() {
  ...
  public static GetContractAdditionsUseCase provideInstance(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    GetContractAdditionsUseCase instance = new GetContractAdditionsUseCase();
  ...
  public static GetContractAdditionsUseCase_Factory create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new GetContractAdditionsUseCase_Factory(
        networkFacadeProvider,
        localStorageProvider,
        schedulersProvider,
        loggerProvider,
  ...
  public static GetContractAdditionsUseCase newGetContractAdditionsUseCase() {
    return new GetContractAdditionsUseCase();
  }
}
