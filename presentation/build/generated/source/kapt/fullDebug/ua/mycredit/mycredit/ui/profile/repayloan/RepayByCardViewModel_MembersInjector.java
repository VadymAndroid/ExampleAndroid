...
public final class RepayByCardViewModel_MembersInjector
    implements MembersInjector<RepayByCardViewModel> {
  ...
  public RepayByCardViewModel_MembersInjector(
  ...
  public static MembersInjector<RepayByCardViewModel> create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new RepayByCardViewModel_MembersInjector(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  @Override
  public void injectMembers(RepayByCardViewModel instance) {
    ...
    injectInitCard(instance);
  }

  public static void injectInitCard(RepayByCardViewModel instance) {
    instance.initCard();
  }
}
