...
public final class GetAgreementUseCase_Factory implements Factory<GetAgreementUseCase> {
  ...
  public GetAgreementUseCase_Factory(
  ...
  public static GetAgreementUseCase provideInstance(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    GetAgreementUseCase instance = new GetAgreementUseCase();
  ...
  public static GetAgreementUseCase_Factory create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new GetAgreementUseCase_Factory(
        networkFacadeProvider,
        localStorageProvider,
        schedulersProvider,
        loggerProvider,
  ...
  public static GetAgreementUseCase newGetAgreementUseCase() {
    return new GetAgreementUseCase();
  }
}
