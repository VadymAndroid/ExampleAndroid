...
public final class RequestResetPasswordSmsUseCase_MembersInjector
    implements MembersInjector<RequestResetPasswordSmsUseCase> {
  ...
  public RequestResetPasswordSmsUseCase_MembersInjector(
  ...
  public static MembersInjector<RequestResetPasswordSmsUseCase> create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new RequestResetPasswordSmsUseCase_MembersInjector(
  ...
  @Override
  public void injectMembers(RequestResetPasswordSmsUseCase instance) {
