...
public final class FinanceViewModel_Factory implements Factory<FinanceViewModel> {
  ...
  public static FinanceViewModel provideInstance(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    FinanceViewModel instance = new FinanceViewModel();
  ...
  public static FinanceViewModel_Factory create(
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new FinanceViewModel_Factory(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  public static FinanceViewModel newFinanceViewModel() {
