...
public final class CardsViewModel_MembersInjector implements MembersInjector<CardsViewModel> {
  ...
  public CardsViewModel_MembersInjector(
  ...
  public static MembersInjector<CardsViewModel> create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new CardsViewModel_MembersInjector(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  @Override
  public void injectMembers(CardsViewModel instance) {
