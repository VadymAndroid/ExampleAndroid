...
public final class ProlongationPreferencesFragment_MembersInjector
    implements MembersInjector<ProlongationPreferencesFragment> {
  ...
  public ProlongationPreferencesFragment_MembersInjector(
  ...
  public static MembersInjector<ProlongationPreferencesFragment> create(
      Provider<DispatchingAndroidInjector<Fragment>> childFragmentInjectorProvider,
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<LocalStorage> storageProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new ProlongationPreferencesFragment_MembersInjector(
  ...
  @Override
  public void injectMembers(ProlongationPreferencesFragment instance) {
