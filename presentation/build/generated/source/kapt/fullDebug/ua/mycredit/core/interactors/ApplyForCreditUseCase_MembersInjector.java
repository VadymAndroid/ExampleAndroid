...
public final class ApplyForCreditUseCase_MembersInjector
    implements MembersInjector<ApplyForCreditUseCase> {
  ...
  public ApplyForCreditUseCase_MembersInjector(
  ...
  public static MembersInjector<ApplyForCreditUseCase> create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new ApplyForCreditUseCase_MembersInjector(
  ...
  @Override
  public void injectMembers(ApplyForCreditUseCase instance) {
