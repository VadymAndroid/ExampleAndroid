...
public final class NewCardBackFragment_MembersInjector
    implements MembersInjector<NewCardBackFragment> {
  ...
  public NewCardBackFragment_MembersInjector(
  ...
  public static MembersInjector<NewCardBackFragment> create(
      Provider<DispatchingAndroidInjector<Fragment>> childFragmentInjectorProvider,
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<LocalStorage> storageProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new NewCardBackFragment_MembersInjector(
  ...
  @Override
  public void injectMembers(NewCardBackFragment instance) {
