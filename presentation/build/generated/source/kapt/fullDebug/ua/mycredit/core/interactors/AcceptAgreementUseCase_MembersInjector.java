...
public final class AcceptAgreementUseCase_MembersInjector
    implements MembersInjector<AcceptAgreementUseCase> {
  ...
  public AcceptAgreementUseCase_MembersInjector(
  ...
  public static MembersInjector<AcceptAgreementUseCase> create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new AcceptAgreementUseCase_MembersInjector(
  ...
  @Override
  public void injectMembers(AcceptAgreementUseCase instance) {
