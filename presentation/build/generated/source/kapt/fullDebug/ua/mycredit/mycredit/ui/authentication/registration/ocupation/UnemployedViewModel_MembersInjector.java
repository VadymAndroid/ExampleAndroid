...
public final class UnemployedViewModel_MembersInjector
    implements MembersInjector<UnemployedViewModel> {
  ...
  public UnemployedViewModel_MembersInjector(
  ...
  public static MembersInjector<UnemployedViewModel> create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new UnemployedViewModel_MembersInjector(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  @Override
  public void injectMembers(UnemployedViewModel instance) {
