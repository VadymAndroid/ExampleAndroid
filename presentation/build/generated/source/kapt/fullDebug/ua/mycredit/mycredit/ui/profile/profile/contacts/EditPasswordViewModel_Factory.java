...
public final class EditPasswordViewModel_Factory implements Factory<EditPasswordViewModel> {
  private final Provider<EditPasswordUseCase> editPasswordProvider;
  ...
  public EditPasswordViewModel_Factory(
      Provider<EditPasswordUseCase> editPasswordProvider,
    ...
    this.editPasswordProvider = editPasswordProvider;
  ...
  public static EditPasswordViewModel provideInstance(
      Provider<EditPasswordUseCase> editPasswordProvider,
      Provider<ResetPasswordUseCase> resetPasswordProvider,
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    EditPasswordViewModel instance =
        new EditPasswordViewModel(editPasswordProvider.get(), resetPasswordProvider.get());
  ...
  public static EditPasswordViewModel_Factory create(
      Provider<EditPasswordUseCase> editPasswordProvider,
      Provider<ResetPasswordUseCase> resetPasswordProvider,
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new EditPasswordViewModel_Factory(
        editPasswordProvider,
        resetPasswordProvider,
        routerProvider,
        eventsProvider,
  ...
  public static EditPasswordViewModel newEditPasswordViewModel(
      EditPasswordUseCase editPassword, ResetPasswordUseCase resetPassword) {
    return new EditPasswordViewModel(editPassword, resetPassword);
  }
}
