...
public final class BusinessmanViewModel_Factory implements Factory<BusinessmanViewModel> {
  ...
  public BusinessmanViewModel_Factory(
  ...
  @Override
  public BusinessmanViewModel get() {
  ...
  public static BusinessmanViewModel provideInstance(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    BusinessmanViewModel instance = new BusinessmanViewModel();
  ...
  public static BusinessmanViewModel_Factory create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new BusinessmanViewModel_Factory(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  public static BusinessmanViewModel newBusinessmanViewModel() {
    return new BusinessmanViewModel();
  }
}
