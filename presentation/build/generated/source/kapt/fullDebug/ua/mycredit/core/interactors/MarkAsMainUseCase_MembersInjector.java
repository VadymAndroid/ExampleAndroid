...
public final class MarkAsMainUseCase_MembersInjector implements MembersInjector<MarkAsMainUseCase> {
  ...
  public MarkAsMainUseCase_MembersInjector(
  ...
  public static MembersInjector<MarkAsMainUseCase> create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new MarkAsMainUseCase_MembersInjector(
  ...
  @Override
  public void injectMembers(MarkAsMainUseCase instance) {
