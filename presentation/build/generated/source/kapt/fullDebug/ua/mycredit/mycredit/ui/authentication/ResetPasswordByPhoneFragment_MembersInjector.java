...
public final class ResetPasswordByPhoneFragment_MembersInjector
    implements MembersInjector<ResetPasswordByPhoneFragment> {
  ...
  public ResetPasswordByPhoneFragment_MembersInjector(
  ...
  public static MembersInjector<ResetPasswordByPhoneFragment> create(
      Provider<DispatchingAndroidInjector<Fragment>> childFragmentInjectorProvider,
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<LocalStorage> storageProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new ResetPasswordByPhoneFragment_MembersInjector(
  ...
  @Override
  public void injectMembers(ResetPasswordByPhoneFragment instance) {
