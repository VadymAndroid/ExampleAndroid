...
public final class EditPasswordFragment_MembersInjector
    implements MembersInjector<EditPasswordFragment> {
  ...
  public EditPasswordFragment_MembersInjector(
  ...
  public static MembersInjector<EditPasswordFragment> create(
      Provider<DispatchingAndroidInjector<Fragment>> childFragmentInjectorProvider,
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<LocalStorage> storageProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new EditPasswordFragment_MembersInjector(
  ...
  @Override
  public void injectMembers(EditPasswordFragment instance) {
