...
public final class PensionerViewModel_MembersInjector
    implements MembersInjector<PensionerViewModel> {
  ...
  public PensionerViewModel_MembersInjector(
  ...
  public static MembersInjector<PensionerViewModel> create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new PensionerViewModel_MembersInjector(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  @Override
  public void injectMembers(PensionerViewModel instance) {
