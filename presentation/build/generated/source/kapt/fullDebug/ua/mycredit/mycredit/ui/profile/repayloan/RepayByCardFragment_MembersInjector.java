...
public final class RepayByCardFragment_MembersInjector
    implements MembersInjector<RepayByCardFragment> {
  ...
  public RepayByCardFragment_MembersInjector(
  ...
  public static MembersInjector<RepayByCardFragment> create(
      Provider<DispatchingAndroidInjector<Fragment>> childFragmentInjectorProvider,
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<LocalStorage> storageProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new RepayByCardFragment_MembersInjector(
  ...
  @Override
  public void injectMembers(RepayByCardFragment instance) {
