...
public final class UseCase_SimpleUseCase_MembersInjector<R>
    implements MembersInjector<UseCase.SimpleUseCase<R>> {
  ...
  public UseCase_SimpleUseCase_MembersInjector(
  ...
  public static <R> MembersInjector<UseCase.SimpleUseCase<R>> create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new UseCase_SimpleUseCase_MembersInjector<R>(
  ...
  @Override
  public void injectMembers(UseCase.SimpleUseCase<R> instance) {
