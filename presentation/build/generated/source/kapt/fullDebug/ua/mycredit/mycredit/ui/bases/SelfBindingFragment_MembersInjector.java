...
public final class SelfBindingFragment_MembersInjector<VDB extends ViewDataBinding>
    implements MembersInjector<SelfBindingFragment<VDB>> {
  ...
  public SelfBindingFragment_MembersInjector(
  ...
  public static <VDB extends ViewDataBinding> MembersInjector<SelfBindingFragment<VDB>> create(
      Provider<DispatchingAndroidInjector<Fragment>> childFragmentInjectorProvider,
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<LocalStorage> storageProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new SelfBindingFragment_MembersInjector<VDB>(
  ...
  @Override
  public void injectMembers(SelfBindingFragment<VDB> instance) {
