...
public final class CheckTinUseCase_MembersInjector implements MembersInjector<CheckTinUseCase> {
  ...
  public CheckTinUseCase_MembersInjector(
  ...
  public static MembersInjector<CheckTinUseCase> create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new CheckTinUseCase_MembersInjector(
  ...
  @Override
  public void injectMembers(CheckTinUseCase instance) {
