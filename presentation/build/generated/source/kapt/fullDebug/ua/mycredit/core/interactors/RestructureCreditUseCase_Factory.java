...
public final class RestructureCreditUseCase_Factory implements Factory<RestructureCreditUseCase> {
  ...
  public RestructureCreditUseCase_Factory(
  ...
  @Override
  public RestructureCreditUseCase get() {
  ...
  public static RestructureCreditUseCase provideInstance(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    RestructureCreditUseCase instance = new RestructureCreditUseCase();
  ...
  public static RestructureCreditUseCase_Factory create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new RestructureCreditUseCase_Factory(
        networkFacadeProvider,
        localStorageProvider,
        schedulersProvider,
        loggerProvider,
  ...
  public static RestructureCreditUseCase newRestructureCreditUseCase() {
    return new RestructureCreditUseCase();
  }
}
