...
public final class ExtraPersonalInfoFragment_MembersInjector
    implements MembersInjector<ExtraPersonalInfoFragment> {
  ...
  public ExtraPersonalInfoFragment_MembersInjector(
  ...
  public static MembersInjector<ExtraPersonalInfoFragment> create(
      Provider<DispatchingAndroidInjector<Fragment>> childFragmentInjectorProvider,
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<LocalStorage> storageProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new ExtraPersonalInfoFragment_MembersInjector(
  ...
  @Override
  public void injectMembers(ExtraPersonalInfoFragment instance) {
