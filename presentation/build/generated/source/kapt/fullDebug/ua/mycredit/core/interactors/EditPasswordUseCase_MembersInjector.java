...
public final class EditPasswordUseCase_MembersInjector
    implements MembersInjector<EditPasswordUseCase> {
  ...
  public EditPasswordUseCase_MembersInjector(
  ...
  public static MembersInjector<EditPasswordUseCase> create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new EditPasswordUseCase_MembersInjector(
  ...
  @Override
  public void injectMembers(EditPasswordUseCase instance) {
