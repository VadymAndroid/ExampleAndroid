...
public final class ResetPasswordUseCase_Factory implements Factory<ResetPasswordUseCase> {
  ...
  public ResetPasswordUseCase_Factory(
  ...
  public static ResetPasswordUseCase provideInstance(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    ResetPasswordUseCase instance = new ResetPasswordUseCase();
  ...
  public static ResetPasswordUseCase_Factory create(
      ...
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new ResetPasswordUseCase_Factory(
        networkFacadeProvider,
        localStorageProvider,
        schedulersProvider,
        loggerProvider,
  ...
  public static ResetPasswordUseCase newResetPasswordUseCase() {
