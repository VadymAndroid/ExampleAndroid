...
public final class UpdateProfileUseCase_MembersInjector
    implements MembersInjector<UpdateProfileUseCase> {
  ...
  public UpdateProfileUseCase_MembersInjector(
  ...
  public static MembersInjector<UpdateProfileUseCase> create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new UpdateProfileUseCase_MembersInjector(
  ...
  @Override
  public void injectMembers(UpdateProfileUseCase instance) {
