...
public final class SignUpProgressViewModel_MembersInjector
    implements MembersInjector<SignUpProgressViewModel> {
  ...
  public SignUpProgressViewModel_MembersInjector(
  ...
  public static MembersInjector<SignUpProgressViewModel> create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new SignUpProgressViewModel_MembersInjector(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  @Override
  public void injectMembers(SignUpProgressViewModel instance) {
