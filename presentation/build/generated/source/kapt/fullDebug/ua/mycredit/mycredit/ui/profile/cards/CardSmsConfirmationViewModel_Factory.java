...
public final class CardSmsConfirmationViewModel_Factory
    implements Factory<CardSmsConfirmationViewModel> {
  ...
  public CardSmsConfirmationViewModel_Factory(
  ...
  @Override
  public CardSmsConfirmationViewModel get() {
  ...
  public static CardSmsConfirmationViewModel provideInstance(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    CardSmsConfirmationViewModel instance = new CardSmsConfirmationViewModel();
  ...
  public static CardSmsConfirmationViewModel_Factory create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new CardSmsConfirmationViewModel_Factory(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  public static CardSmsConfirmationViewModel newCardSmsConfirmationViewModel() {
    return new CardSmsConfirmationViewModel();
  }
}
