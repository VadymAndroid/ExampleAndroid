...
public final class TemporarilyUnemployedViewModel_MembersInjector
    implements MembersInjector<TemporarilyUnemployedViewModel> {
  ...
  public TemporarilyUnemployedViewModel_MembersInjector(
  ...
  public static MembersInjector<TemporarilyUnemployedViewModel> create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new TemporarilyUnemployedViewModel_MembersInjector(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  @Override
  public void injectMembers(TemporarilyUnemployedViewModel instance) {
