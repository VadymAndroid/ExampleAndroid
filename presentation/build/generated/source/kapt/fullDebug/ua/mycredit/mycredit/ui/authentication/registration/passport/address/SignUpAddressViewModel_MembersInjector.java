...
public final class SignUpAddressViewModel_MembersInjector
    implements MembersInjector<SignUpAddressViewModel> {
  ...
  public SignUpAddressViewModel_MembersInjector(
  ...
  public static MembersInjector<SignUpAddressViewModel> create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new SignUpAddressViewModel_MembersInjector(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  @Override
  public void injectMembers(SignUpAddressViewModel instance) {
