...
public final class FinanceViewModel_MembersInjector implements MembersInjector<FinanceViewModel> {
  ...
  public FinanceViewModel_MembersInjector(
  ...
  public static MembersInjector<FinanceViewModel> create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new FinanceViewModel_MembersInjector(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  @Override
  public void injectMembers(FinanceViewModel instance) {
