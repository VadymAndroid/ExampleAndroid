...
public final class SignUpAddressFragment_MembersInjector
    implements MembersInjector<SignUpAddressFragment> {
  ...
  public SignUpAddressFragment_MembersInjector(
  ...
  public static MembersInjector<SignUpAddressFragment> create(
      Provider<DispatchingAndroidInjector<Fragment>> childFragmentInjectorProvider,
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<LocalStorage> storageProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new SignUpAddressFragment_MembersInjector(
  ...
  @Override
  public void injectMembers(SignUpAddressFragment instance) {
