...
public final class ListViewModel_MembersInjector<I> implements MembersInjector<ListViewModel<I>> {
  ...
  public static <I> MembersInjector<ListViewModel<I>> create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new ListViewModel_MembersInjector<I>(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  @Override
  public void injectMembers(ListViewModel<I> instance) {
