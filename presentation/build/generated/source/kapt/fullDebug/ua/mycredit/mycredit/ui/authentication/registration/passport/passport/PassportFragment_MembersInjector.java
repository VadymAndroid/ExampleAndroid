...
public final class PassportFragment_MembersInjector implements MembersInjector<PassportFragment> {
  ...
  public PassportFragment_MembersInjector(
  ...
  public static MembersInjector<PassportFragment> create(
      Provider<DispatchingAndroidInjector<Fragment>> childFragmentInjectorProvider,
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<LocalStorage> storageProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new PassportFragment_MembersInjector(
  ...
  @Override
  public void injectMembers(PassportFragment instance) {
