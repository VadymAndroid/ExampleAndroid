...
public final class WebBankingActivity_MembersInjector
    implements MembersInjector<WebBankingActivity> {
  ...
  public WebBankingActivity_MembersInjector(
  ...
  public static MembersInjector<WebBankingActivity> create(
      Provider<DispatchingAndroidInjector<Fragment>> supportFragmentInjectorProvider,
      Provider<DispatchingAndroidInjector<android.app.Fragment>> frameworkFragmentInjectorProvider,
      Provider<NavigatorHolder> navigatorHolderProvider,
      Provider<LocalStorage> storageProvider,
      ...
      Provider<AppEvents> eventsProvider,
      Provider<Logger> loggerProvider) {
    return new WebBankingActivity_MembersInjector(
  ...
  @Override
  public void injectMembers(WebBankingActivity instance) {
