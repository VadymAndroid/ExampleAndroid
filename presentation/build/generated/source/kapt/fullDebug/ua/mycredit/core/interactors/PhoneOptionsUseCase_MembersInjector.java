...
public final class PhoneOptionsUseCase_MembersInjector
    implements MembersInjector<PhoneOptionsUseCase> {
  ...
  public PhoneOptionsUseCase_MembersInjector(
  ...
  public static MembersInjector<PhoneOptionsUseCase> create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new PhoneOptionsUseCase_MembersInjector(
  ...
  @Override
  public void injectMembers(PhoneOptionsUseCase instance) {
