...
public final class GetProductByPromoCodeUseCase_MembersInjector
    implements MembersInjector<GetProductByPromoCodeUseCase> {
  ...
  public GetProductByPromoCodeUseCase_MembersInjector(
  ...
  public static MembersInjector<GetProductByPromoCodeUseCase> create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new GetProductByPromoCodeUseCase_MembersInjector(
  ...
  @Override
  public void injectMembers(GetProductByPromoCodeUseCase instance) {
