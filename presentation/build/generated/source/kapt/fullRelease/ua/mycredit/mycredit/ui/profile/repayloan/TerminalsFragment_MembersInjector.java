...
public final class TerminalsFragment_MembersInjector implements MembersInjector<TerminalsFragment> {
  ...
  public TerminalsFragment_MembersInjector(
  ...
  public static MembersInjector<TerminalsFragment> create(
      Provider<DispatchingAndroidInjector<Fragment>> childFragmentInjectorProvider,
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<LocalStorage> storageProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new TerminalsFragment_MembersInjector(
  ...
  @Override
  public void injectMembers(TerminalsFragment instance) {
