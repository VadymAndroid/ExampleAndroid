...
public final class CheckTinUseCase_Factory implements Factory<CheckTinUseCase> {
  ...
  public CheckTinUseCase_Factory(
  ...
  public static CheckTinUseCase provideInstance(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    CheckTinUseCase instance = new CheckTinUseCase();
  ...
  public static CheckTinUseCase_Factory create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new CheckTinUseCase_Factory(
        networkFacadeProvider,
        localStorageProvider,
        schedulersProvider,
        loggerProvider,
  ...
  public static CheckTinUseCase newCheckTinUseCase() {
    return new CheckTinUseCase();
  }
}
