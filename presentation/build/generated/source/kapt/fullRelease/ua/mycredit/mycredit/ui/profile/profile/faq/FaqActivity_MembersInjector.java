...
public final class FaqActivity_MembersInjector implements MembersInjector<FaqActivity> {
  ...
  public FaqActivity_MembersInjector(
  ...
  public static MembersInjector<FaqActivity> create(
      Provider<DispatchingAndroidInjector<Fragment>> supportFragmentInjectorProvider,
      Provider<DispatchingAndroidInjector<android.app.Fragment>> frameworkFragmentInjectorProvider,
      Provider<NavigatorHolder> navigatorHolderProvider,
      Provider<LocalStorage> storageProvider,
      ...
      Provider<Logger> loggerProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new FaqActivity_MembersInjector(
  ...
  @Override
  public void injectMembers(FaqActivity instance) {
