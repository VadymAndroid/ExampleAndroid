...
public final class LoadCardsUseCase_MembersInjector implements MembersInjector<LoadCardsUseCase> {
  ...
  public LoadCardsUseCase_MembersInjector(
  ...
  public static MembersInjector<LoadCardsUseCase> create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new LoadCardsUseCase_MembersInjector(
  ...
  @Override
  public void injectMembers(LoadCardsUseCase instance) {
