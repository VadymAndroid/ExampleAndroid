...
public final class StudentViewModel_MembersInjector implements MembersInjector<StudentViewModel> {
  ...
  public StudentViewModel_MembersInjector(
  ...
  public static MembersInjector<StudentViewModel> create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new StudentViewModel_MembersInjector(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  @Override
  public void injectMembers(StudentViewModel instance) {
