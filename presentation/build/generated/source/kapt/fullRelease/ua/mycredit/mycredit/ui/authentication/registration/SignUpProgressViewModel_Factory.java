...
public final class SignUpProgressViewModel_Factory implements Factory<SignUpProgressViewModel> {
  ...
  public SignUpProgressViewModel_Factory(
  ...
  @Override
  public SignUpProgressViewModel get() {
  ...
  public static SignUpProgressViewModel provideInstance(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    SignUpProgressViewModel instance = new SignUpProgressViewModel();
  ...
  public static SignUpProgressViewModel_Factory create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new SignUpProgressViewModel_Factory(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  public static SignUpProgressViewModel newSignUpProgressViewModel() {
    return new SignUpProgressViewModel();
  }
}
