...
public final class TemporarilyUnemployedViewModel_Factory
    implements Factory<TemporarilyUnemployedViewModel> {
  ...
  public TemporarilyUnemployedViewModel_Factory(
  ...
  @Override
  public TemporarilyUnemployedViewModel get() {
  ...
  public static TemporarilyUnemployedViewModel provideInstance(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    TemporarilyUnemployedViewModel instance = new TemporarilyUnemployedViewModel();
  ...
  public static TemporarilyUnemployedViewModel_Factory create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new TemporarilyUnemployedViewModel_Factory(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  public static TemporarilyUnemployedViewModel newTemporarilyUnemployedViewModel() {
    return new TemporarilyUnemployedViewModel();
  }
}
