...
public final class DeleteCardUseCase_MembersInjector implements MembersInjector<DeleteCardUseCase> {
  ...
  public DeleteCardUseCase_MembersInjector(
  ...
  public static MembersInjector<DeleteCardUseCase> create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new DeleteCardUseCase_MembersInjector(
  ...
  @Override
  public void injectMembers(DeleteCardUseCase instance) {
