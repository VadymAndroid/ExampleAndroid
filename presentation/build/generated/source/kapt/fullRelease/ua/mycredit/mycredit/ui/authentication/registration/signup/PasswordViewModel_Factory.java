...
public final class PasswordViewModel_Factory implements Factory<PasswordViewModel> {
  ...
  public PasswordViewModel_Factory(
  ...
  public static PasswordViewModel provideInstance(
      Provider<FbEmailDelegate> delegateProvider,
      Provider<SignInUseCase> signInProvider,
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    PasswordViewModel instance =
        new PasswordViewModel(delegateProvider.get(), signInProvider.get());
  ...
  public static PasswordViewModel_Factory create(
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new PasswordViewModel_Factory(
        delegateProvider,
        signInProvider,
        routerProvider,
        eventsProvider,
  ...
  public static PasswordViewModel newPasswordViewModel(
      FbEmailDelegate delegate, SignInUseCase signIn) {
    return new PasswordViewModel(delegate, signIn);
  }
}
