...
public final class EmployedViewModel_MembersInjector implements MembersInjector<EmployedViewModel> {
  ...
  public EmployedViewModel_MembersInjector(
  ...
  public static MembersInjector<EmployedViewModel> create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new EmployedViewModel_MembersInjector(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  @Override
  public void injectMembers(EmployedViewModel instance) {
