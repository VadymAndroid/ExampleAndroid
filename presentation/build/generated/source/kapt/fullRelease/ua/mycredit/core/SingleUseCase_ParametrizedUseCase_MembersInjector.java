...
public final class SingleUseCase_ParametrizedUseCase_MembersInjector<P, R>
    implements MembersInjector<SingleUseCase.ParametrizedUseCase<P, R>> {
  ...
  public SingleUseCase_ParametrizedUseCase_MembersInjector(
  ...
  public static <P, R> MembersInjector<SingleUseCase.ParametrizedUseCase<P, R>> create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new SingleUseCase_ParametrizedUseCase_MembersInjector<P, R>(
  ...
  @Override
  public void injectMembers(SingleUseCase.ParametrizedUseCase<P, R> instance) {
