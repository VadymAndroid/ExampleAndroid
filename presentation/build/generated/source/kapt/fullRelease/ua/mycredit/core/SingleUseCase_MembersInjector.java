...
public final class SingleUseCase_MembersInjector<P, R>
    implements MembersInjector<SingleUseCase<P, R>> {
  ...
  public SingleUseCase_MembersInjector(
  ...
  public static <P, R> MembersInjector<SingleUseCase<P, R>> create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new SingleUseCase_MembersInjector<P, R>(
  ...
  @Override
  public void injectMembers(SingleUseCase<P, R> instance) {
