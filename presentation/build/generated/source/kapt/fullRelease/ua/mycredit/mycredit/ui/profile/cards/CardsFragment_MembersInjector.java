...
public final class CardsFragment_MembersInjector implements MembersInjector<CardsFragment> {
  ...
  public CardsFragment_MembersInjector(
  ...
  public static MembersInjector<CardsFragment> create(
      Provider<DispatchingAndroidInjector<Fragment>> childFragmentInjectorProvider,
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<LocalStorage> storageProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new CardsFragment_MembersInjector(
  ...
  @Override
  public void injectMembers(CardsFragment instance) {
