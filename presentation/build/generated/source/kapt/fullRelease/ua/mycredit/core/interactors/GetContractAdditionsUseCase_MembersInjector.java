...
public final class GetContractAdditionsUseCase_MembersInjector
    implements MembersInjector<GetContractAdditionsUseCase> {
  ...
  public GetContractAdditionsUseCase_MembersInjector(
  ...
  public static MembersInjector<GetContractAdditionsUseCase> create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new GetContractAdditionsUseCase_MembersInjector(
  ...
  @Override
  public void injectMembers(GetContractAdditionsUseCase instance) {
