...
public final class SignUpPhoneViewModel_MembersInjector
    implements MembersInjector<SignUpPhoneViewModel> {
  ...
  public SignUpPhoneViewModel_MembersInjector(
  ...
  public static MembersInjector<SignUpPhoneViewModel> create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new SignUpPhoneViewModel_MembersInjector(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  @Override
  public void injectMembers(SignUpPhoneViewModel instance) {
