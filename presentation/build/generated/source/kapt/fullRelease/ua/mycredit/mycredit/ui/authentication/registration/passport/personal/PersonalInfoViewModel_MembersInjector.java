...
public final class PersonalInfoViewModel_MembersInjector
    implements MembersInjector<PersonalInfoViewModel> {
  ...
  public PersonalInfoViewModel_MembersInjector(
  ...
  public static MembersInjector<PersonalInfoViewModel> create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new PersonalInfoViewModel_MembersInjector(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  @Override
  public void injectMembers(PersonalInfoViewModel instance) {
