...
public final class PhoneOptionsUseCase_Factory implements Factory<PhoneOptionsUseCase> {
  ...
  public PhoneOptionsUseCase_Factory(
  ...
  @Override
  public PhoneOptionsUseCase get() {
  ...
  public static PhoneOptionsUseCase provideInstance(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    PhoneOptionsUseCase instance = new PhoneOptionsUseCase();
  ...
  public static PhoneOptionsUseCase_Factory create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new PhoneOptionsUseCase_Factory(
        networkFacadeProvider,
        localStorageProvider,
        schedulersProvider,
        loggerProvider,
  ...
  public static PhoneOptionsUseCase newPhoneOptionsUseCase() {
    return new PhoneOptionsUseCase();
  }
}
