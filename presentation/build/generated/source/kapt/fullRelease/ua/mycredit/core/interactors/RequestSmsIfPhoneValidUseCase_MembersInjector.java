...
public final class RequestSmsIfPhoneValidUseCase_MembersInjector
    implements MembersInjector<RequestSmsIfPhoneValidUseCase> {
  ...
  public RequestSmsIfPhoneValidUseCase_MembersInjector(
  ...
  public static MembersInjector<RequestSmsIfPhoneValidUseCase> create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new RequestSmsIfPhoneValidUseCase_MembersInjector(
  ...
  @Override
  public void injectMembers(RequestSmsIfPhoneValidUseCase instance) {
