...
public final class OccupationTypeViewModel_MembersInjector
    implements MembersInjector<OccupationTypeViewModel> {
  ...
  public OccupationTypeViewModel_MembersInjector(
  ...
  public static MembersInjector<OccupationTypeViewModel> create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new OccupationTypeViewModel_MembersInjector(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  @Override
  public void injectMembers(OccupationTypeViewModel instance) {
    ...
    injectUpdateIncomeParams(instance);
  }

  public static void injectUpdateIncomeParams(OccupationTypeViewModel instance) {
    instance.updateIncomeParams();
  }
}
