...
public final class LoadHistoryUseCase_MembersInjector
    implements MembersInjector<LoadHistoryUseCase> {
  ...
  public LoadHistoryUseCase_MembersInjector(
  ...
  public static MembersInjector<LoadHistoryUseCase> create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new LoadHistoryUseCase_MembersInjector(
  ...
  @Override
  public void injectMembers(LoadHistoryUseCase instance) {
