...
public final class HousewifeViewModel_Factory implements Factory<HousewifeViewModel> {
  ...
  public HousewifeViewModel_Factory(
  ...
  public static HousewifeViewModel provideInstance(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    HousewifeViewModel instance = new HousewifeViewModel();
  ...
  public static HousewifeViewModel_Factory create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new HousewifeViewModel_Factory(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  public static HousewifeViewModel newHousewifeViewModel() {
    return new HousewifeViewModel();
  }
}
