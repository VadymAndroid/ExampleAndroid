...
public final class GetAgreementUseCase_MembersInjector
    implements MembersInjector<GetAgreementUseCase> {
  ...
  public GetAgreementUseCase_MembersInjector(
  ...
  public static MembersInjector<GetAgreementUseCase> create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new GetAgreementUseCase_MembersInjector(
  ...
  @Override
  public void injectMembers(GetAgreementUseCase instance) {
