...
public final class AgreementFragment_MembersInjector implements MembersInjector<AgreementFragment> {
  ...
  public AgreementFragment_MembersInjector(
  ...
  public static MembersInjector<AgreementFragment> create(
      Provider<DispatchingAndroidInjector<Fragment>> childFragmentInjectorProvider,
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<LocalStorage> storageProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new AgreementFragment_MembersInjector(
  ...
  @Override
  public void injectMembers(AgreementFragment instance) {
