...
public final class CardsPickerFragment_MembersInjector
    implements MembersInjector<CardsPickerFragment> {
  ...
  public CardsPickerFragment_MembersInjector(
  ...
  public static MembersInjector<CardsPickerFragment> create(
      Provider<DispatchingAndroidInjector<Fragment>> childFragmentInjectorProvider,
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<LocalStorage> storageProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new CardsPickerFragment_MembersInjector(
  ...
  @Override
  public void injectMembers(CardsPickerFragment instance) {
