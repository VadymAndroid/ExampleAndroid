...
public final class BusinessmanViewModel_MembersInjector
    implements MembersInjector<BusinessmanViewModel> {
  ...
  public BusinessmanViewModel_MembersInjector(
  ...
  public static MembersInjector<BusinessmanViewModel> create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new BusinessmanViewModel_MembersInjector(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  @Override
  public void injectMembers(BusinessmanViewModel instance) {
