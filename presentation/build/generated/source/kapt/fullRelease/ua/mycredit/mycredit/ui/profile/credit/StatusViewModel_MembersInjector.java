...
public final class StatusViewModel_MembersInjector implements MembersInjector<StatusViewModel> {
  ...
  public StatusViewModel_MembersInjector(
  ...
  public static MembersInjector<StatusViewModel> create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new StatusViewModel_MembersInjector(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  public static void injectOnInjected(StatusViewModel instance) {
    instance.onInjected();
  }
}
