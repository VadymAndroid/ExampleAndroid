...
public final class PasswordViewModel_MembersInjector implements MembersInjector<PasswordViewModel> {
  ...
  public PasswordViewModel_MembersInjector(
  ...
  public static MembersInjector<PasswordViewModel> create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new PasswordViewModel_MembersInjector(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  @Override
  public void injectMembers(PasswordViewModel instance) {
