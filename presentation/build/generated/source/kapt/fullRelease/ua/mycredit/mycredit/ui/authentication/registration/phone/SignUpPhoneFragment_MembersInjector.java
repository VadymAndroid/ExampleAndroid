...
public final class SignUpPhoneFragment_MembersInjector
    implements MembersInjector<SignUpPhoneFragment> {
  ...
  public SignUpPhoneFragment_MembersInjector(
  ...
  public static MembersInjector<SignUpPhoneFragment> create(
      Provider<DispatchingAndroidInjector<Fragment>> childFragmentInjectorProvider,
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<LocalStorage> storageProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new SignUpPhoneFragment_MembersInjector(
  ...
  @Override
  public void injectMembers(SignUpPhoneFragment instance) {
