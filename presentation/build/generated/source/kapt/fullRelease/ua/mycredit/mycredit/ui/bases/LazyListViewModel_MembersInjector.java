...
public final class LazyListViewModel_MembersInjector<I>
    implements MembersInjector<LazyListViewModel<I>> {
  ...
  public LazyListViewModel_MembersInjector(
  ...
  public static <I> MembersInjector<LazyListViewModel<I>> create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new LazyListViewModel_MembersInjector<I>(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  @Override
  public void injectMembers(LazyListViewModel<I> instance) {
