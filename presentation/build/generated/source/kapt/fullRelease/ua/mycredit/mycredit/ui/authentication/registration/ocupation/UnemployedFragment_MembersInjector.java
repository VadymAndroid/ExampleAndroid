...
public final class UnemployedFragment_MembersInjector
    implements MembersInjector<UnemployedFragment> {
  ...
  public UnemployedFragment_MembersInjector(
  ...
  public static MembersInjector<UnemployedFragment> create(
      Provider<DispatchingAndroidInjector<Fragment>> childFragmentInjectorProvider,
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<LocalStorage> storageProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new UnemployedFragment_MembersInjector(
  ...
  @Override
  public void injectMembers(UnemployedFragment instance) {
