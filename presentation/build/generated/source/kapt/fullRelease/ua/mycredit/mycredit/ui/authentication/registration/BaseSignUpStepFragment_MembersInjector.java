...
public final class BaseSignUpStepFragment_MembersInjector<
        VM extends FormViewModel, VDB extends ViewDataBinding>
    implements MembersInjector<BaseSignUpStepFragment<VM, VDB>> {
  ...
  public BaseSignUpStepFragment_MembersInjector(
  ...
  public static <VM extends FormViewModel, VDB extends ViewDataBinding>
      MembersInjector<BaseSignUpStepFragment<VM, VDB>> create(
          Provider<DispatchingAndroidInjector<Fragment>> childFragmentInjectorProvider,
          Provider<Router> routerProvider,
          Provider<AppEvents> eventsProvider,
          Provider<LocalStorage> storageProvider,
          Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new BaseSignUpStepFragment_MembersInjector<VM, VDB>(
  ...
  @Override
  public void injectMembers(BaseSignUpStepFragment<VM, VDB> instance) {
