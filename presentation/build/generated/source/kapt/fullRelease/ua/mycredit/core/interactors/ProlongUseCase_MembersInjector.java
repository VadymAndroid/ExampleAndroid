...
public final class ProlongUseCase_MembersInjector implements MembersInjector<ProlongUseCase> {
  ...
  public ProlongUseCase_MembersInjector(
  ...
  public static MembersInjector<ProlongUseCase> create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new ProlongUseCase_MembersInjector(
  ...
  @Override
  public void injectMembers(ProlongUseCase instance) {
