...
public final class CPAUseCase_MembersInjector implements MembersInjector<CPAUseCase> {
  ...
  public CPAUseCase_MembersInjector(
  ...
  public static MembersInjector<CPAUseCase> create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new CPAUseCase_MembersInjector(
  ...
  @Override
  public void injectMembers(CPAUseCase instance) {
