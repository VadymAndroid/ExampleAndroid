...
public final class SignInUseCase_MembersInjector implements MembersInjector<SignInUseCase> {
  ...
  public SignInUseCase_MembersInjector(
  ...
  public static MembersInjector<SignInUseCase> create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new SignInUseCase_MembersInjector(
  ...
  @Override
  public void injectMembers(SignInUseCase instance) {
