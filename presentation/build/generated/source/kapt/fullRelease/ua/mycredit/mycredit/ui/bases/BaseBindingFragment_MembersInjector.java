...
public final class BaseBindingFragment_MembersInjector<VDB extends ViewDataBinding>
    implements MembersInjector<BaseBindingFragment<VDB>> {
  ...
  public static <VDB extends ViewDataBinding> MembersInjector<BaseBindingFragment<VDB>> create(
      Provider<DispatchingAndroidInjector<Fragment>> childFragmentInjectorProvider,
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<LocalStorage> storageProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new BaseBindingFragment_MembersInjector<VDB>(
  ...
  @Override
  public void injectMembers(BaseBindingFragment<VDB> instance) {
