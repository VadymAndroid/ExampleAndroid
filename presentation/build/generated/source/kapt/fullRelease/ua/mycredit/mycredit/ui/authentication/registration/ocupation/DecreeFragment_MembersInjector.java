...
public final class DecreeFragment_MembersInjector implements MembersInjector<DecreeFragment> {
  ...
  public DecreeFragment_MembersInjector(
  ...
  public static MembersInjector<DecreeFragment> create(
      Provider<DispatchingAndroidInjector<Fragment>> childFragmentInjectorProvider,
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<LocalStorage> storageProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new DecreeFragment_MembersInjector(
  ...
  @Override
  public void injectMembers(DecreeFragment instance) {
