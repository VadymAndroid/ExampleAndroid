...
public final class TemporarilyUnemployedFragment_MembersInjector
    implements MembersInjector<TemporarilyUnemployedFragment> {
  ...
  public TemporarilyUnemployedFragment_MembersInjector(
  ...
  public static MembersInjector<TemporarilyUnemployedFragment> create(
      Provider<DispatchingAndroidInjector<Fragment>> childFragmentInjectorProvider,
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<LocalStorage> storageProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new TemporarilyUnemployedFragment_MembersInjector(
  ...
  @Override
  public void injectMembers(TemporarilyUnemployedFragment instance) {
