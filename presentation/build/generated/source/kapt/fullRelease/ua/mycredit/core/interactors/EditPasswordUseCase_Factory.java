...
public final class EditPasswordUseCase_Factory implements Factory<EditPasswordUseCase> {
  ...
  public EditPasswordUseCase_Factory(
  ...
  @Override
  public EditPasswordUseCase get() {
  ...
  public static EditPasswordUseCase provideInstance(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    EditPasswordUseCase instance = new EditPasswordUseCase();
  ...
  public static EditPasswordUseCase_Factory create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new EditPasswordUseCase_Factory(
        networkFacadeProvider,
        localStorageProvider,
        schedulersProvider,
        loggerProvider,
  ...
  public static EditPasswordUseCase newEditPasswordUseCase() {
    return new EditPasswordUseCase();
  }
}
