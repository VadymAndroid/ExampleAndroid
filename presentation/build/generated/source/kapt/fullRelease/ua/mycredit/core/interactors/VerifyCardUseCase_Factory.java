...
public final class VerifyCardUseCase_Factory implements Factory<VerifyCardUseCase> {
  ...
  public VerifyCardUseCase_Factory(
  ...
  public static VerifyCardUseCase provideInstance(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    VerifyCardUseCase instance = new VerifyCardUseCase();
  ...
  public static VerifyCardUseCase_Factory create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new VerifyCardUseCase_Factory(
        networkFacadeProvider,
        localStorageProvider,
        schedulersProvider,
        loggerProvider,
  ...
  public static VerifyCardUseCase newVerifyCardUseCase() {
    return new VerifyCardUseCase();
  }
}
