...
public final class PensionerFragment_MembersInjector implements MembersInjector<PensionerFragment> {
  ...
  public PensionerFragment_MembersInjector(
  ...
  public static MembersInjector<PensionerFragment> create(
      Provider<DispatchingAndroidInjector<Fragment>> childFragmentInjectorProvider,
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<LocalStorage> storageProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new PensionerFragment_MembersInjector(
  ...
  @Override
  public void injectMembers(PensionerFragment instance) {
