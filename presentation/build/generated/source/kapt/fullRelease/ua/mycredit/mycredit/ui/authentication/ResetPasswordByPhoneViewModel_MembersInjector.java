...
public final class ResetPasswordByPhoneViewModel_MembersInjector
    implements MembersInjector<ResetPasswordByPhoneViewModel> {
  ...
  public ResetPasswordByPhoneViewModel_MembersInjector(
  ...
  public static MembersInjector<ResetPasswordByPhoneViewModel> create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new ResetPasswordByPhoneViewModel_MembersInjector(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  @Override
  public void injectMembers(ResetPasswordByPhoneViewModel instance) {
