...
public final class VerifyCardUseCase_MembersInjector implements MembersInjector<VerifyCardUseCase> {
  ...
  public VerifyCardUseCase_MembersInjector(
  ...
  public static MembersInjector<VerifyCardUseCase> create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new VerifyCardUseCase_MembersInjector(
  ...
  @Override
  public void injectMembers(VerifyCardUseCase instance) {
