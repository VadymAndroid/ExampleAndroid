...
public final class ExtraPersonalInfoViewModel_MembersInjector
    implements MembersInjector<ExtraPersonalInfoViewModel> {
  ...
  public ExtraPersonalInfoViewModel_MembersInjector(
  ...
  public static MembersInjector<ExtraPersonalInfoViewModel> create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new ExtraPersonalInfoViewModel_MembersInjector(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  @Override
  public void injectMembers(ExtraPersonalInfoViewModel instance) {
