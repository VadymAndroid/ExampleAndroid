...
public final class BankFragmentViewModel_Factory implements Factory<BankFragmentViewModel> {
  ...
  public BankFragmentViewModel_Factory(
  ...
  @Override
  public BankFragmentViewModel get() {
  ...
  public static BankFragmentViewModel provideInstance(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    BankFragmentViewModel instance = new BankFragmentViewModel();
  ...
  public static BankFragmentViewModel_Factory create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new BankFragmentViewModel_Factory(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  public static BankFragmentViewModel newBankFragmentViewModel() {
    return new BankFragmentViewModel();
  }
}
