...
public final class ViewModelFragment_MembersInjector<
        VM extends BaseViewModel, VDB extends ViewDataBinding>
    implements MembersInjector<ViewModelFragment<VM, VDB>> {
  ...
  public static <VM extends BaseViewModel, VDB extends ViewDataBinding>
      MembersInjector<ViewModelFragment<VM, VDB>> create(
          Provider<DispatchingAndroidInjector<Fragment>> childFragmentInjectorProvider,
          Provider<Router> routerProvider,
          Provider<AppEvents> eventsProvider,
          Provider<LocalStorage> storageProvider,
          Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new ViewModelFragment_MembersInjector<VM, VDB>(
  ...
  @Override
  public void injectMembers(ViewModelFragment<VM, VDB> instance) {
