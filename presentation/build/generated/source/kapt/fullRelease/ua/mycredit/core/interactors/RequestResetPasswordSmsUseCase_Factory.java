...
public final class RequestResetPasswordSmsUseCase_Factory
    implements Factory<RequestResetPasswordSmsUseCase> {
  ...
  public RequestResetPasswordSmsUseCase_Factory(
  ...
  @Override
  public RequestResetPasswordSmsUseCase get() {
  ...
  public static RequestResetPasswordSmsUseCase provideInstance(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    RequestResetPasswordSmsUseCase instance = new RequestResetPasswordSmsUseCase();
  ...
  public static RequestResetPasswordSmsUseCase_Factory create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new RequestResetPasswordSmsUseCase_Factory(
        networkFacadeProvider,
        localStorageProvider,
        schedulersProvider,
        loggerProvider,
  ...
  public static RequestResetPasswordSmsUseCase newRequestResetPasswordSmsUseCase() {
    return new RequestResetPasswordSmsUseCase();
  }
}
