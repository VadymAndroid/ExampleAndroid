...
public final class PensionerViewModel_Factory implements Factory<PensionerViewModel> {
  ...
  public PensionerViewModel_Factory(
  ...
  public static PensionerViewModel provideInstance(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    PensionerViewModel instance = new PensionerViewModel();
  ...
  public static PensionerViewModel_Factory create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new PensionerViewModel_Factory(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  public static PensionerViewModel newPensionerViewModel() {
    return new PensionerViewModel();
  }
}
