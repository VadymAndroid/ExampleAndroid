...
public final class CardBackFragment_MembersInjector implements MembersInjector<CardBackFragment> {
  ...
  public CardBackFragment_MembersInjector(
  ...
  public static MembersInjector<CardBackFragment> create(
      Provider<DispatchingAndroidInjector<Fragment>> childFragmentInjectorProvider,
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<LocalStorage> storageProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new CardBackFragment_MembersInjector(
  ...
  @Override
  public void injectMembers(CardBackFragment instance) {
