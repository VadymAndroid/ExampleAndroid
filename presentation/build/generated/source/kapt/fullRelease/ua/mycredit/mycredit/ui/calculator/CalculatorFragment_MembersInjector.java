...
public final class CalculatorFragment_MembersInjector
    implements MembersInjector<CalculatorFragment> {
  ...
  public CalculatorFragment_MembersInjector(
  ...
  public static MembersInjector<CalculatorFragment> create(
      Provider<DispatchingAndroidInjector<Fragment>> childFragmentInjectorProvider,
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<LocalStorage> storageProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new CalculatorFragment_MembersInjector(
  ...
  @Override
  public void injectMembers(CalculatorFragment instance) {
