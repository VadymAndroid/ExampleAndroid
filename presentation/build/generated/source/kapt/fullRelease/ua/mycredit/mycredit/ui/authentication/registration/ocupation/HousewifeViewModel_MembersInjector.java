...
public final class HousewifeViewModel_MembersInjector
    implements MembersInjector<HousewifeViewModel> {
  ...
  public HousewifeViewModel_MembersInjector(
  ...
  public static MembersInjector<HousewifeViewModel> create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new HousewifeViewModel_MembersInjector(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  @Override
  public void injectMembers(HousewifeViewModel instance) {
