...
public final class CalculatorViewModel_MembersInjector
    implements MembersInjector<CalculatorViewModel> {
  ...
  public CalculatorViewModel_MembersInjector(
  ...
  public static MembersInjector<CalculatorViewModel> create(
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<Logouter> logouterProvider,
      Provider<FirebaseAnalytics> analyticsProvider,
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new CalculatorViewModel_MembersInjector(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  @Override
  public void injectMembers(CalculatorViewModel instance) {
    ...
    injectOnInjected(instance);
  }

  public static void injectOnInjected(CalculatorViewModel instance) {
    instance.onInjected();
  }
}
