...
public final class EmployedFragment_MembersInjector implements MembersInjector<EmployedFragment> {
  ...
  public EmployedFragment_MembersInjector(
  ...
  public static MembersInjector<EmployedFragment> create(
      Provider<DispatchingAndroidInjector<Fragment>> childFragmentInjectorProvider,
      Provider<Router> routerProvider,
      Provider<AppEvents> eventsProvider,
      Provider<LocalStorage> storageProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new EmployedFragment_MembersInjector(
  ...
  @Override
  public void injectMembers(EmployedFragment instance) {
