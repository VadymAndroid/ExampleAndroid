...
public final class ProfileViewModel_MembersInjector implements MembersInjector<ProfileViewModel> {
  ...
  public ProfileViewModel_MembersInjector(
  ...
  public static MembersInjector<ProfileViewModel> create(
      ...
      Provider<LocalStorage> storageProvider,
      Provider<Logger> loggerProvider) {
    return new ProfileViewModel_MembersInjector(
        routerProvider,
        eventsProvider,
        logouterProvider,
        analyticsProvider,
  ...
  public void injectMembers(ProfileViewModel instance) {
    ...
    injectUpdateBadges(instance);
  }

  public static void injectUpdateBadges(ProfileViewModel instance) {
