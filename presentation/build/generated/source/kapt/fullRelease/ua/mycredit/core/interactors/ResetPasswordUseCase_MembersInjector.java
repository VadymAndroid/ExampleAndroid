...
public final class ResetPasswordUseCase_MembersInjector
    implements MembersInjector<ResetPasswordUseCase> {
  ...
  public ResetPasswordUseCase_MembersInjector(
  ...
  public static MembersInjector<ResetPasswordUseCase> create(
      Provider<NetworkFacade> networkFacadeProvider,
      Provider<LocalStorage> localStorageProvider,
      Provider<Map<BaseUseCase.SchedulerType, ? extends Scheduler>> schedulersProvider,
      Provider<Logger> loggerProvider,
      Provider<AppMetaData> appMetaDataProvider) {
    return new ResetPasswordUseCase_MembersInjector(
  ...
  @Override
  public void injectMembers(ResetPasswordUseCase instance) {
